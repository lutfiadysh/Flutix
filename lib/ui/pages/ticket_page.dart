        ...
        children: <Widget>[
          ...
          BlocBuilder<TicketBloc , TicketState>(
            builder:  (_, ticketState) =>  Container(
              ...
              ? ticketState.tickets.where((ticket)=> ticket.date.isBefore(DateTime.now())).toList()
              : ticketState.tickets.where((ticket)=> !ticket.date.isBefore(DateTime.now())).toList()
              ),
            ),
          ),
...
class TicketViewer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    sortedTickets.sort((ticket1,ticket2) => ticket1.date.compareTo(ticket2.date));
    return ListView.builder(
      itemCount: sortedTickets.length,
      itemBuilder: (_, index) => GestureDetector(
        onTap: (){
          context.bloc<PageBloc>().add(GoToTicketDetailPage(sortedTickets[index]));
        },
        child: Container(
